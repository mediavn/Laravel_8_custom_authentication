          ...
          <div class="columns">
            ...
            <div class="column right has-text-centered">
              ...
              @csrf
                ...
                <div class="field">
                  <div class="control">
                    <input class="input is-medium" type="text" placeholder="Name" name="name" value="{{ @old('name') }}"> 
                ...
                <div class="field">
                  <div class="control">
                    <input class="input is-medium" type="email" placeholder="Email" name="email" value="{{ @old('email') }}">
                    <p class="help is-danger">@error('email'){{ $message }} @enderror</p>
                  </div>
                </div>
                <div class="field">
                <div class="control">
                    <input class="input is-medium" type="password" placeholder="**********" autocomplete="current-password" name="password" value="{{ @old('name') }}"/>
                ...
                <br />
                <small><a href="login">I already have account</a></small>
              </form>
            </div>
          </div>
        </div>
